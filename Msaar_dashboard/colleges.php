...
?>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="AddEditCollege.php" class="btn btn-primary"><i class="plus"></i>إضافة كلية</a>
    ...
    <div class="table-responsive">
        ...
        <tbody>
        <?php if(!empty($college)){ $count = 0; foreach($college as $row){ $count++; ?>
            <tr>
                <td><?php echo $row['Id_College']; ?></td>
                <td><?php echo $row['Name']; ?></td>
                <td><?php $count2 = 0; foreach($region as $row3){ $count2++; if($row['Id_Region']==$row3['Id_Region']){ echo $row3['Name'];}} ?></td>
               
                <td>
                <a href="AddEditCollege.php?id=<?php echo $row['Id_College']; ?>" class="btn icon icon-left btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>تعديل</a>
